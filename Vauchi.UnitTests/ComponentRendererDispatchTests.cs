...
public class ComponentRendererDispatchTests
{
    ...
    [InlineData("""{"EditableText": {"id": "et1", "label": "Name", "value": "Alice", "edit_text": "Edit name", "save_text": "Save", "cancel_text": "Cancel", "edit_action_id": "opaque.edit", "save_action_id": "opaque.save", "cancel_action_id": "opaque.cancel", "editing": false}}""", "EditableText")]
    [InlineData("""{"ImageCircle": {"id": "img1", "image_data": null, "initials": "AG", "brightness": 0.0, "editable": true, "edit_action_id": "opaque/image-edit#4"}}""", "ImageCircle")]
